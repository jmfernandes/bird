...
static PhidgetReturnCode PhidgetSpatialDevice_setDataRate(mosiop_t iop, PhidgetSpatialDeviceHandle phid, int milliseconds);
...
PhidgetSpatialDevice_bridgeInput(PhidgetChannelHandle ch, BridgePacket *bp) {
	...
	case PHIDCHCLASS_ACCELEROMETER:
		...
		case BP_SETDATAINTERVAL:
			return (PhidgetSpatialDevice_setDataRate(bp->iop, phid, getBridgePacketUInt32(bp, 0)));
...
static PhidgetReturnCode
PhidgetSpatialDevice_setDataRate(mosiop_t iop, PhidgetSpatialDeviceHandle phid, int newVal) {
