...
#ifdef NDEBUG
#define nclogdebug(...)
#define nclogcrit(...) PhidgetLog_loge(NULL, 0, NULL, NETCTLS, PHIDGET_LOG_CRITICAL, __VA_ARGS__)
#define nclogerr(...) PhidgetLog_loge(NULL, 0, NULL, NETCTLS, PHIDGET_LOG_ERROR, __VA_ARGS__)
#define nclogwarn(...) PhidgetLog_loge(NULL, 0, NULL, NETCTLS, PHIDGET_LOG_WARNING, __VA_ARGS__)
#define ncloginfo(...) PhidgetLog_loge(NULL, 0, NULL, NETCTLS, PHIDGET_LOG_INFO, __VA_ARGS__)
#define nclogverbose(...)
#else
