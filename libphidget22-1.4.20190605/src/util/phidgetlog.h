...
#ifdef NDEBUG
#define logdebug(...)
#define logcrit(...) PhidgetLog_loge(NULL, 0, NULL, NULL, PHIDGET_LOG_CRITICAL, __VA_ARGS__)
#define logerr(...) PhidgetLog_loge(NULL, 0, NULL, NULL, PHIDGET_LOG_ERROR, __VA_ARGS__)
#define logwarn(...) PhidgetLog_loge(NULL, 0, NULL, NULL, PHIDGET_LOG_WARNING, __VA_ARGS__)
#define loginfo(...) PhidgetLog_loge(NULL, 0, NULL, NULL, PHIDGET_LOG_INFO, __VA_ARGS__)
#define logverbose(...)
#else
